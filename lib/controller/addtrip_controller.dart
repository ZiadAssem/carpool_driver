...
class AddTripController {
  static void addTrip(context ,route, destination, gate, date, int price, int seats) {
  if (destination == 'toCampus') {
    destination = 'Campus';
  } else {
    destination = 'Home';
  }
  final userName = DatabaseHelper.instance.currentUser.name;
