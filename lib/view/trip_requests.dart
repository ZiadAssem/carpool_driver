    ...
    child: ListTile(
      ...
      subtitle: Column(
        ...
        children: [
          ...
          SizedBox(height: 8), // Add some spacing between the subtitle texts
          Text('Pickup: ' + trips[index].pickup),
          Text(
            trips[index].status.toString(),
            style: TextStyle(
              color: trips[index].status == 'confirmed' ? Colors.green : Colors.red,
            ),
          ),
        ],
      ),
      ...
      IconButton(onPressed: (){
        DatabaseHelper.instance.deleteRequest(trips[index].requestId, trips[index].user);
          ...
          Row(
            ...
            children: [
              IconButton(
                ...
                onPressed: () {
                  DatabaseHelper.instance.acceptTripRequest(
